...
// Source: https://raw.githubusercontent.com/microsoft/onnxruntime/v1.24.2/include/onnxruntime/core/session/onnxruntime_c_api.h
package v24

// APIVersion is the ONNX Runtime C API version (24).
const APIVersion = 24
...
// API contains function pointers to the ONNX Runtime C API (version 24).
// Field order MUST match the actual OrtApi structure from onnxruntime_c_api.h
// https://raw.githubusercontent.com/microsoft/onnxruntime/v1.24.2/include/onnxruntime/core/session/onnxruntime_c_api.h
type API struct {
